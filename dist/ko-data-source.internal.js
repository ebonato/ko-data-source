...
ko_data_source_default_observable_state_transitioner = function (ko) {
  ...
  DefaultObservableStateTransitioner.prototype = {
    'constructor': function (entry) {
      ...
      var makeObservable = function (o, bindingObservable)
        //create observables recursively
        {
    ...
    'updater': function (observable, updatedEntry) {
      ...
      if (!isObservableProperty)
        return observable;
      var updateObservable = function (o, bindingObservable)
        //update observables recursively
        {
          Object.keys(o).forEach(function (p) {
            if (typeof o[p] === 'object' && o[p] !== null) {
